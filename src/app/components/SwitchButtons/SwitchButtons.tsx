...
const SwitchButtons: React.FC<SwitchButtonsProps> = ({ onButtonClick }) => {
  ...
  return (
    <div className="flex flex-row w-full md:w-min ">
      <div
        onClick={() => handleButtonClick(ESwitchButton.All)}
        className={`cursor-pointer p-1 font-semibold text-md  md:w-16 w-full rounded-s flex items-center justify-center ${
      ...
      <div
        ...
        className={`cursor-pointer p-1 font-semibold text-md  md:w-16 w-full  flex items-center justify-center ${
      ...
      <div
        ...
        className={`cursor-pointer p-2 font-semibold rounded-e text-md  md:w-16 w-full  flex items-center justify-center ${
